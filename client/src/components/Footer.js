    ...
    return (
        <footer class="custom-footer">
            <div>
                ...
                <a href="https://www.facebook.com/kanayo.ifediora" target="_blank" rel="noreferrer"><i className = "custom-footer-icons bi bi-facebook"></i></a>
            </div>
            <div>
                Copyright&copy; 2025 QuickBasket
            </div>
        </footer>
    )
