  ...
  return (
    <div className="d-flex flex-column align-items-center">
      ...
      <div className="custom-singleProduct-page">
          ...
          <div className="product-layout">
            <div>
              ...
              <section className="product-info">
                ...
                <p className="fs-1 fw-bold" style={{ color: "var(--theme)" }}>
                  ${priceFormatter(product.price)}
                </p>
                <p
                  className={
                    !product.averageRating ? "text-muted fst-italic" : ""
                  }
                >
                  Rating:{" "}
              ...
              {activeTab === "reviews" && product.reviews?.length > 0
                ? product.reviews.map((review, index) => (
                    <div className="user-review" key={index}>
                      ...
                      <p style={{ fontSize: "clamp(0.6rem, 2vw, 1rem)" }}>
                        Rating: {ratingConverter(review.rating)}
                      </p>
                    </div>
                  ))
                : activeTab === "reviews" && (
                    <p className="m-3 fs-5">No reviews yet.</p>
                  )}
            </section>
          </div>
        )}
        ...
        {/* Checks login status and displays below message if not loggedin and trying to purchase product */}
        {!loggedInStatus && (
          <div className="alert p-0 pb-2">
            <div
              style={{ backgroundColor: "var(--theme)" }}
              className="d-flex align-items-center justify-items-start"
            >
